...
#define L1_BYPASS_DIV 0
#define STATISTIC_BYPASS_L1CACHE 0
#define STATISTIC_BYPASS_L2CACHE 0

/*L1VC cache */
#define USE_L1VC  0   //VC開關
#define L1VC_DIV_LOWER 0
#define L1VC_DIV_UPPER 2

/*L2 cache */
#define USE_L2_BYPASS 0
#define L2_BYPASS_LOWER 1
#define L2_BYPASS_UPPER 1
#define USE_ICNTTOL2_FS_QUEUE  0  //已經確定只會有限制div的資料會進去
#define USE_L2TOICNT_FS_QUEUE  1  //已經確定只會有限制div的資料會進去(1,33 IPC=157.3112)
